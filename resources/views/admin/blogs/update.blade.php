                            ...
                            <div class="row">
                                                    ...
                                                    <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input  type="text"  placeholder="Enter Title" class="form-control" name="title[{{ $key }}]" value="{{ old('title' . $key,$blog->getTranslation('title', $key)) }}">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ old('slug' . $key, $blog->getTranslation('slug', $key)) }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <img class="img-fluid" style="height: 306px"
