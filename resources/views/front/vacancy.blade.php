...
<head>
    ...
    <title>{!!$metatag->vacancy_title!!}</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="{!!$metatag->vacancy_desc!!}">
    <meta content="{!!$metatag->vacancy_keywords!!}" name="keywords">
...
@section('content')
    <div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1">
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h2 data-aos="fade-up" data-aos-delay="200">@lang('menu.vacancy')</h2>
                <ul data-aos="fade-up" data-aos-delay="400">
                    <li><a href="{{route('front.home')}}">@lang('menu.home')</a></li>
                    <li><i class="ti-angle-right"></i></li>
                    <li>@lang('menu.vacancy')</li>
                </ul>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="container">
            <div class="faq-area" data-aos="fade-up" data-aos-delay="400">
                <div class="row">
                    @foreach ($vacancies as $vacancy)
                    <div class="col-lg-12" style="margin-bottom: 10px;">
                        <button class="faq-accordion">{{$vacancy->title}}</button>
                        <div class="faq-panel">
                            {!!$vacancy->desc!!}
                        </div>
                    </div>
